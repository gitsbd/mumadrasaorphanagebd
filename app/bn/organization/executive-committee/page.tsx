...
export default function ExecutiveCommitteePageBn() {
  const executiveMembers = [
    { name: "Md. Shahnewaz Zaman (Shanto)", designation: "নির্বাহী পরিচালক", mobile: "+1 (917) 651-6554" },
    { name: "Md. Monirul Islam", designation: "সভাপতি", mobile: "01728-014014" },
    { name: "Md. Salehin Maruf", designation: "সহ-সভাপতি", mobile: "01790-388477" },
    { name: "Md. Fazlur Rahman", designation: "সহ-সভাপতি", mobile: "01317-244684" },
    { name: "Abu Salim Sujon", designation: "সাধারণ সম্পাদক", mobile: "01791-206098" },
    { name: "Md. Rifat Mia", designation: "যুগ্ম সাধারণ সম্পাদক", mobile: "01732-195296" },
    { name: "Nur Alam", designation: "কোষাধ্যক্ষ", mobile: "01885-420204" },
  ];
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="mb-8">
          <BaseLink href="/bn" className="inline-flex items-center text-islamic-green hover:text-islamic-dark transition-colors mb-4">
            <ArrowLeft className="h-4 w-4 mr-2" />
            <span className="bangla-text">হোমে ফিরে যান</span>
          </BaseLink>
          <h1 className="bangla-text text-4xl font-bold text-gray-900 mb-2">এক্সিকিউটিভ কমিটি</h1>
          <p className="bangla-text text-gray-600">তথ্যসূত্র: এক্সিকিউটিভ কমিটি | তারিখ: ১১ মার্চ ২০২৫</p>
        </div>
                ...
                {executiveMembers.map((member, index) => (
                  <tr key={index} className="border-b border-gray-200 hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4">
                      <a href={`tel:${member.mobile.replace(/\s/g, "")}`} className="text-islamic-green hover:text-islamic-dark font-medium transition-colors flex items-center space-x-2">
