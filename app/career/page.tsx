...
export default function Career() {
  const teacherPositions = [
    ...
    {
      title: "Islamic & General Education Teacher",
      department: "Islamic Studies & General Education Department",
      type: "Full-time",
      requirements: [
        "Degree in Islamic Studies (Alim/Dawrah preferred) or relevant general education subject (Bangla, English, Math, or General Knowledge)",
        "Strong knowledge of Aqeedah, Fiqh, Seerah, and Hadith with ability to integrate Islamic values in teaching",
        "Experience teaching Islamic and/or general education subjects",
        "Ability to explain complex concepts simply to different age groups",
        "Commitment to orphan education, child development, and Islamic principles",
      ],
      responsibilities: [
        "Teach Islamic Studies (Aqeedah, Fiqh, Seerah, Hadith) and/or general subjects such as Bangla, English, Math, or General Knowledge",
        "Develop age-appropriate lesson plans and teaching materials",
        "Maintain student progress records, assessment, and regular feedback",
        "Create engaging, disciplined, and Islamic learning environments",
        "Support students' overall academic, moral, and personal development",
      ],
    },
    {
      title: "Operations Manager",
      department: "Administration & Operations",
      type: "Full-time (Residential Preferred)",
      requirements: [
        "Strong Islamic character (Amanah, Taqwa, leadership qualities)",
        "Graduate in Islamic Studies / Alim / Hifz preferred",
        "Minimum 3–5 years of madrasa or organizational management experience",
        "Strong organizational, leadership, and communication skills",
        "Proven financial accountability and transparency",
        "Ability to manage teams and handle multiple responsibilities under pressure",
        "Basic computer skills (Email, MS Office, reporting) preferred",
      ],
      responsibilities: [
        "Oversee daily operations of the madrasa and orphanage, ensuring smooth administration and student welfare",
        "Supervise teachers, staff, and support personnel while maintaining discipline and an Islamic environment",
        "Monitor academic programs (Noorani, Hifz, Islamic Studies, General Education) and evaluate teacher performance",
        "Maintain academic, administrative, and financial records with proper reporting systems",
        "Oversee donations, sponsorships, and funding activities with full financial transparency",
        "Prepare monthly and annual financial and activity reports in coordination with Treasurer and Committee",
        "Lead infrastructure and facility development (mosque, classrooms, boarding, utilities, solar, sound systems, etc.)",
        "Communicate with donors, sponsors, guardians, and community partners; represent the institution in meetings and events",
        "Manage official communication channels including email, letters, and documentation, and support fundraising initiatives",
        "Ensure legal and regulatory compliance with Bangladesh laws, registration, constitution, and committee decisions",
      ],
    },
  ];
